...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='@Nw_movies')
            ],
            [
                InlineKeyboardButton('Join', url=f"@Nw_Mv"),
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='@NW_movies'),
            InlineKeyboardButton('Movie Club ⭕️', url='@Nw_Mv')
            ],[
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support', url='@Nw_Mv'),
            InlineKeyboardButton('Channel ⭕️', url='@Nw_movies')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'later we start')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
